...
$wp_customize->add_section( 'header_options' , array(
    ...
    //Zigzag custom Start
    $wp_customize->add_setting('newses_header_enabled',
    array(
        'default' => true,
        'sanitize_callback' => 'newses_sanitize_checkbox',
    )
    ...
    $wp_customize->add_control(new Newses_Toggle_Control( $wp_customize, 'newses_header_enabled', 
        array(
            'label' => esc_html__('Hide / Show Header toolbar', 'newses'),
            'type' => 'toggle',
            'section' => 'header_options',
        )
    ));
    ...
    $wp_customize->add_setting( 
        'newses_header_prefix_image', array(
        'sanitize_callback' => 'esc_url_raw',
    ) );

    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'newses_header_prefix_image', array(
        'label'    => __( 'Background Image', 'newses' ),
        'section'  => 'header_options',
        'settings' => 'newses_header_prefix_image',
    ) ) );
