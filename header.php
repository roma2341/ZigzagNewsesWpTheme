    ...
    <div class="wrapper">
        <header class="mg-headwidget">
            ...
            <?php 
                ...
                $newses_header_prefix_image = get_theme_mod('newses_header_prefix_image',false); 
                    ...
                    <div class="mg-nav-widget-area">
                        <div class="row align-items-center">
                            <div class="col-md-2 text-center-xs">
                                <img class="newses_header_prefix_image" src="<?php echo esc_url( $newses_header_prefix_image ); ?>">
                            </div>
