...
Extended version of newses theme for wordpress, added:
-Image before title text
Fork of https://demos.themeansar.com/newses

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Zigzag-Newses in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.

== Copyright ==

Zigzag-Newses WordPress Theme, Copyright (c) 2020, Themeansar
Zigzag-Newses is distributed under the terms of the GNU GPLs
